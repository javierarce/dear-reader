...
class Reader {
  ...
  generateEPUB () {
    return new Promise(async (resolve, reject) => {
      ...
      contents += `<div class="Intro">${new Date().toLocaleTimeString()}. Sit ullam adipisci repellendus animi eligendi aliquam vitae, ratione qui Possimus odit nulla maiores earum quisquam </div>`
