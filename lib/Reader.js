...
class Reader {
  ...
  async getWeatherDescription () {
    ...
    return `${description}. The temperature in ${city} is ${temperature}ºC (feels like ${feelsLike}ºC). Humidity: ${humidity}%. Sunset time is ${sunset}.`
  }
  ...
  async writeBook () {
    ...
    let filename = `${BOOK_DIRECTORY}${title}.png`
